...
function DrinkCardComplete({name,alcoholPercentage,ingredients,imageSrc}:{ name: string, alcoholPercentage: string, ingredients: any ,imageSrc:any}) {
    ...
    return (
        <View style={styles.container}>
            { isOpen ?
                // @ts-ignore
                <Overlay  overlayStyle={{marginVertical:50, marginHorizontal:50,alignContent:"center"} } isVisible={isOpen} onBackdropPress={() => setOpen(false)}>
